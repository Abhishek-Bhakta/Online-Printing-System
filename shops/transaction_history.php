...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content"style="background-color:rgba(224, 235, 219, 0.83);">
               ...
               <h4 style="font-size: 45px;">Transaction History</h4>
               <input type="text" id="searchTransactionInput" class="form-control" placeholder="Search Transactions..." style="width: 300px; margin-bottom: 15px;">
    ...
    document.getElementById("searchTransactionInput").addEventListener("input", searchTransactions);

    function searchTransactions() {
        let searchValue = document.getElementById("searchTransactionInput").value.toLowerCase().trim();
        let tableBody = document.querySelector(".order-history-page tbody");
        ...
        // If nothing is found, show "No matching transactions found."
        if (matchedRows.length === 0) {
            tableBody.innerHTML = "<tr><td colspan='6' class='text-center text-danger fw-bold'>No matching transactions found.</td></tr>";
        }
    }
